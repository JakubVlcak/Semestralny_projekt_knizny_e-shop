...
-- -----------------------------------------------------
-- Table `mydb`.`books_has_cart`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`books_has_cart` (
  ...
  INDEX `fk_books_has_cart_books_idx` (`books_idbooks` ASC) VISIBLE,
